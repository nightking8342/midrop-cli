# -*- coding: utf-8 -*-
"""Send / devices business flows on top of mapping, launch, popup, uia."""
...
def send_file(
    ...
    """Trigger MiDrop picker and optionally click a matching device."""
    t0 = time.time()
    ...
    try:
        with hold_mapping(path):
            ...
            # Keep mapping briefly so user can click manually when list was visible.
